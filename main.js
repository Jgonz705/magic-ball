...
answerElement.classList.add('fade', 'text-center', 'fs-1', 'fw-bold', 'bg-white','text-primary', 'px-2', 'py-3', 'rounded', 'w-50',  'position-absolute', 'top-50', 'start-50', 'translate-middle')
